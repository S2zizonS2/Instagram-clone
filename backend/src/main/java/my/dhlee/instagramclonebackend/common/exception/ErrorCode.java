...
public enum ErrorCode {
    ...
    // 회원가입, 계정
    DUPLICATE_USER_ID(HttpStatus.BAD_REQUEST, "A000", "동일한 아이디가 존재합니다."),
    ...
    WRONG_EMAIL_CODE(HttpStatus.BAD_REQUEST, "A009", "잘못된 인증번호입니다. 인증번호를 확인해주세요."),
    VERIFY_CODE_EXPIRED(HttpStatus.BAD_REQUEST, "A010", "이미 만료된 인증코드입니다."),
